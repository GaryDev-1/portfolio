...
const projects = [
  {
    ...
    category: "frontend",
    title: "project 1",
    description: "Lorem ipsum odor amet, consectetuer adipiscing elit. Integer nascetur nunc; praesent mi natoque rutrum accumsan.",
    stack: [
      {
        name: "HTML5"
      },
                  ...
                  return <>
                    <SwiperSlide key={index} className="w-full">
                      <div className="h-[460px] relative group flex justify-center items-center bg-pink-50/20">
                        {/* overlay */}
                        <div className="absolute top-0 bottom-0 w-full h-full bg-block/10 z-10"></div>
                        {/* image */}
